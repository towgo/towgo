...
type Driver interface {
	...
	GenScanResult(string) (interface{}, error) // according given column types generating a suitable scan interface
...
func OpenDialect(driverName, connstr string) (Dialect, error) {
	...
	if dialect == nil {
		return nil, fmt.Errorf("unsupported dialect types: %v", uri.DBType)
	}
